...
let s:colors = {
      \ "red": get(s:overrides, "red", { "gui": "#F07178", "cterm": "204", "cterm16": "1" }),
      \ "light_red": get(s:overrides, "light_red", { "gui": "#FF5370", "cterm": "204", "cterm16": "1" }),
      ...
      \ "purple": get(s:overrides, "purple", { "gui": "#C590E8", "cterm": "170", "cterm16": "5" }),
      \ "cyan": get(s:overrides, "cyan", { "gui": "#8EDDFD", "cterm": "38", "cterm16": "6" }),
      \ "white": get(s:overrides, "white", { "gui": "#bfc7d5", "cterm": "145", "cterm16": "7" }),
      \ "black": get(s:overrides, "black", { "gui": "#292D3F", "cterm": "235", "cterm16": "0" }),
      ...
      \ "dark_blue": get(s:overrides, "dark_blue", { "gui": "#BFC7D5", "cterm": "NONE", "cterm16": "0" }),
      \}
